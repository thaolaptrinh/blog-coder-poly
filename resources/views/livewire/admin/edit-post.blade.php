            ...
            <div class="card">
                <form wire:submit.prevent='update'>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="mb-3">
                                    ...
                                    @if ($newThumbnail?->temporaryUrl())
                                        <img src="{{ $newThumbnail->temporaryUrl() }}" alt="{{ __('Thumbnail') }}"
                                            style="max-width: 230px; max-height: 230px;margin-top: 10px;" />
                                    @else
                                        @if (!empty($thumbnail))
                                            <img src="{{ $thumbnail }}" alt="{{ __('Thumbnail') }}"
                                                style="max-width: 230px; max-height: 230px;margin-top: 10px;" />
                                        @else
                    ...
                    <div class="card-footer text-end">
                        <a href="{{ route('guest.post', $slug) }}" target="_blank"
                            class="btn btn-secondary">@lang('View')</a>
